...
$result = $instance->checkAdminLoginInfo($username, $password);
...
if ($result != 1) {
    ...
    $existingToken = $instance->getTokenForUsernameForAdmins($username);
    if ($existingToken != "") {
        $response = array(
            "result" => "1",
            "username" => $username,
    ...
    if (-1 == $instance->addSessionForAdmins($username, $randomToken)) {
